...
ACMACS_BASE_SOURCES = virus-name.cc color.cc text-style.cc time-series.cc read-file.cc layout.cc \
		      json-importer.cc rjson.cc rjson-parser-pop.cc argc-argv.cc quicklook.cc timeit.cc
