...
namespace acmacs::settings::v2
{
    ...
    class Settings
    {
      public:
        ...
        substitute_result_t substitute(const rjson::v3::value& source, if_no_substitution_found ifnsf = if_no_substitution_found::empty) const;
        ...
        std::string substitute_to_string(const rjson::v3::value& source, if_no_substitution_found ifnsf = if_no_substitution_found::empty) const;
