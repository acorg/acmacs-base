...
namespace rjson::v3
{
    ...
    constexpr inline auto detail::array::begin() const noexcept { return content_.begin(); }
    constexpr inline auto detail::array::end() const noexcept { return content_.end(); }
